...
mlflow.set_experiment("Tourism Package Purchase Prediction")    # complete the code to set the MLflow experiment name (same as the dev experimentation cell)
...
param_grid = {
    ...
    'xgbclassifier__colsample_bylevel': [0.8],   # Fraction of features sampled at each tree level.
    'xgbclassifier__learning_rate': [0.05, 0.10],       # Step size used during boosting. Smaller values may improve generalization but require more trees.
...
with mlflow.start_run():
    ...
    model_path = "tourism_project/deployment/tourism_model.joblib"   # Specify the local file path (inside tourism_project/deployment/) where the trained model should be saved.
